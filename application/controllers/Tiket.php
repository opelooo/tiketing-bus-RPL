...
class Tiket extends CI_Controller {
	...
	public function index(){
		...
		// $data['asal'] = $this->db->query("SELECT * FROM `tbl_asal` ORDER BY kota_asal ASC ")->result_array();
	...
	public function cekjadwal($tgl='' , $asl='', $tjn=''){
		...
		// $data['asal'] = $this->db->query("SELECT * FROM tbl_asal WHERE kd_asal ='$asal'")->row_array();
		$getTime = date('H:i:s');
		$data['jadwal'] = $this->db->query("SELECT * FROM tbl_jadwal LEFT JOIN tbl_bus on tbl_jadwal.kd_bus = tbl_bus.kd_bus LEFT JOIN tbl_tujuan on tbl_jadwal.kd_tujuan = tbl_tujuan.kd_tujuan WHERE tbl_jadwal.wilayah_jadwal ='$tujuan' AND jam_berangkat_jadwal > '$getTime'")->result_array();
	...
	public function gettiket($value=''){
	    ...
	    // $asal =  $this->db->query("SELECT * FROM tbl_asal 	WHERE kd_asal ='".$this->session->userdata('asal')."'")->row_array();		
