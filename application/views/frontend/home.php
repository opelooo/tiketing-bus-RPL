				...
				<div class="row fullscreen d-flex align-items-center justify-content-end">
					<div class="banner-content col-lg-7 col-md-12">
						<h4  class="combined">Jaminan Tiket Resmi</h4>
							<h2 class="combined" >
						Tiket ARSYAD TRANS dijamin resmi, pastikan Anda bisa pergi!				
							</h2>
						<p class="text-white" >
							Sekarang cari tiket bus semakin mudah, bisa pesan online di Tiket ARSYAD TRANS. Tak perlu repot ke terminal atau kantor agen, sekarang Anda bisa beli tiket dengan mudah. Booking Cepat dan Mudah. Bebas Pilih Kursi. Termurah Setiap Hari. Customer Service 24/7. Semua Kelas dan Rute.
						</p>
